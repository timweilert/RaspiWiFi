...
print()
print()
entered_ssid = 'DavidLynchWeather'#input("Please enter an SSID you'd like to use \nfor Host/Configuration mode? [default: RaspiWiFi Setup]: ")
print()
wpa_enabled_choice = 'N' #input("Would you like WPA encryption enabled on the hotspot \nwhile in Configuration Mode? [y/N]:")
print()
...
print()
auto_config_choice 'N' #= input("Would you like to enable \nauto-reconfiguration mode [y/N]?: ")
print()
...
print()
server_port_choice = '80' #input("Which port would you like to use for the Configuration Page? [default: 80]: ")
print()
ssl_enabled_choice = 'N' #input("Would you like to enable SSL during configuration mode \n(NOTICE: you will get a certificate ID error \nwhen connecting, but traffic will be encrypted) [y/N]?: ")
default_dhcpcd_choice = 'y' #do we want to use a default dhcpcd.conf file when attaching to the wifi network we've chosen? default: Y
os.system('clear')
print()
print()
install_ans = 'y' #input("Are you ready to commit changes to the system? [y/N]: ")
...
reboot_ans = 'y' #input("Would you like to do that now? [y/N]: ")
